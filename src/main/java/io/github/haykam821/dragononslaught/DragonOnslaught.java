...
public class DragonOnslaught implements ModInitializer {
	...
	public static final GameType<DragonOnslaughtConfig> GAME_TYPE = GameType.register(GAME_TYPE_ID, DragonOnslaughtConfig.CODEC, DragonOnslaughtWaitingPhase::open);
